/*  ECE-4730     : Introduction to Parallel Systems
    ...
    Description: This program writes to output_file a binary file with an n vector where the
                 value of each element of the matrix is randomly generated based on a uniform random variable 
                 ...
                 The first 32-bit integer of the file should be ‘r’ the number of values in the vector.
...
int main(int argc, char* argv[])
{
    ...
    while ((x = getopt(argc, argv, "r:l:u:o:")) != -1)
    {
        switch (x)
        {
        case 'r':
